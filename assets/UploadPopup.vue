...
const emit = defineEmits(["update:modelValue", "upload", "cameraUpload", "createFolder", "createText"]);
</script>
<template>
  <div class="popup">
        ...
        <div class="button-grid">
          <button onclick="this.lastElementChild.click()">
            ...
            <input
              ...
              capture="camera"
              hidden
              @change="emit('cameraUpload', $event.target)"
            />
          </button>
          <button onclick="this.lastElementChild.click()">
          ...
          <button type="button" @click="emit('createText')">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
              <path
